  ...
  const checkSource = () => {
    switch(title) {
      ...
      case "diamondsInTheRough":
        ...
        setPurpose(`The Wall Street Bets community on Reddit is now somewhat of a notorious group of financial speculators. I wondered if there was a way to track
         the stocks that they are talking about in the community, and as I have come to learn - anything is possible with the use of software. I get data from a 
         third-party website which tracks the data and I output it to my site, providing all the important information regarding financial instruments, which I get 
         from an API, such as P/E ratios, charts, market cap, and so on`);
        setChallenges(`
      ...
      case "weatherApp":
        ...
        setPurpose(`I was curious as to how and where the weather app on my phone gets its data,
         so I went down a rabbit hole of APIs and found OpenWeatherAPI. I used it to create my own weather app. `);
        setChallenges(`
